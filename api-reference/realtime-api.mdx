...
<CodeGroup>
```bash cURL
curl -X GET "https://api.bouncewatch.com/api/v1/company/stripe.com?mode=realtime&enrich=business,technology" \
  -H "X-API-Key: YOUR_API_KEY"
```

```javascript JavaScript
const response = await fetch(
  'https://api.bouncewatch.com/api/v1/company/stripe.com?mode=realtime&enrich=business,technology',
...
```php PHP
$ch = curl_init('https://api.bouncewatch.com/api/v1/company/stripe.com?mode=realtime&enrich=business,technology');
